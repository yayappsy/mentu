...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/stats/statsSiteLanguage/"><spring:message code="admin.statsSiteLanguage"/><spring:message code="admin.common.list"/></a></li>
		<li class="active"><a href="${ctx}/stats/statsSiteLanguage/form?id=${statsSiteLanguage.id}">
		    <shiro:hasPermission name="stats:statsSiteLanguage:edit">
		       <spring:message code="admin.statsSiteLanguage"/>
		       <spring:message code="admin.common.${not empty statsSiteLanguage.id?'edit':'add'}"/>
		    </shiro:hasPermission>
		    <shiro:lacksPermission name="stats:statsSiteLanguage:edit">
		           <spring:message code="admin.statsSiteLanguage"/><spring:message code="admin.common.view"/>
		    </shiro:lacksPermission>
		    </a>
		</li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="statsSiteLanguage" action="${ctx}/stats/statsSiteLanguage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<weimhc:message resultMessage="${resultMessage}"/>		
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.pageViewCount"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.visitorCount"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.newVisitorCount"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.newVisitorRate"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.browseCount"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.ipCount"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.bounceRate"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.conversionsCount"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.conversionsRate"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.averageBrowsePageCount"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.averageAccessTime"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.language"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.dimensions"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.year"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.month"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.day"/>：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><spring:message code="StatsSiteLanguage.hour"/>：</label>
			<div class="controls">
