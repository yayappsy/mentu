...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/company/company/list">企业列表</a></li>
		<shiro:hasPermission name="company:company:edit"><li><a href="${ctx}/company/company/form">企业添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="company" action="${ctx}/company/company/list" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>是否首页展示：</label>
				<form:radiobutton path="homeShow" value=""  />全部
				<form:radiobutton path="homeShow" value="1"  />显示
				<form:radiobutton path="homeShow" value="0"  />不显示
			</li>
			<li class="btns">
