...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/company/company/form?id=${company.id}">企业<shiro:hasPermission name="company:company:edit">${not empty company.id?'审核':'添加'}</shiro:hasPermission><shiro:lacksPermission name="company:company:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
