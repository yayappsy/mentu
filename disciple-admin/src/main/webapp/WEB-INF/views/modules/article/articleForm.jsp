...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/article/article/"><spring:message
					code="admin.article.list" /></a></li>
		<li class="active"><a
			href="${ctx}/article/article/form?id=${article.id}"> <shiro:hasPermission
	...
	<form:form id="inputForm" modelAttribute="article"
		action="${ctx}/article/article/save" method="post"
