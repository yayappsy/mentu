...
<meta name="decorator" content="stats_default"/>
   ...
   <script type="text/javascript" src="${ctxStatic}/biaozhun/js/searchengine.js"></script>
    <style>
...
<div class="selectbox">
    <div class="top">
        <div class="sclef fl icon">搜索引擎(2017/04/12)<span class="glyphicon glyphicon-question-sign cs" aria-hidden="true"></span></div>
        <div class="scrig fr">
    ...
    <div class="sr_wrap2">
            ...
            <table class="summary" style="width:100%;">
                ...
                <tr>
                    <td><span class="text">浏览量(PV)<a href="javascript:void(0);" data="pv_count" class="help">&nbsp;</a></span>
                        <div class="value summary-ellipsis" id="eng_pv_count" title="1,225">1,225</div>
                    </td>
                    <td><span class="text">访客数(UV)<a href="javascript:void(0);" data="visitor_count" class="help">&nbsp;</a></span>
                        <div class="value summary-ellipsis" id="eng_visitor_count" title="924">924</div>
                    </td>
                    <td><span class="text">IP数<a href="javascript:void(0);" data="ip_count" class="help">&nbsp;</a></span>
                        <div class="value summary-ellipsis" id="eng_ip_count" title="873">873</div>
                    </td>
                    <td><span class="text">跳出率<a href="javascript:void(0);" data="bounce_ratio" class="help">&nbsp;</a></span>
                        <div class="value summary-ellipsis" id="eng_bounce_ratio"  title="90.22%">90.22%</div>
                    </td>
                    <td class="last"><span class="text">平均访问时长<a href="javascript:void(0);" data="avg_visit_time" class="help">&nbsp;</a></span>
                        <div class="value summary-ellipsis" id="eng_avg_visit_time" title="00:03:18">00:03:18</div>
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div id="table">
            <table class="table table-layout-02">
                ...
                <tr class="group-title" >
                    ...
                    <td class="table-index" data="source_engine_title" id="source_engine_title" colspan="1" rowspan="2">
                        <div class="td-content">搜索引擎</div>
                    </td>
                ...
                <tr class="" >
                    ...
                    <td class="summary source_engine_title"   colspan="2">
                        <div class="td-content" title="">当前汇总</div>
                    </td>
                    <td class="number group pv_count"   colspan="">
                        <div class="td-content" id="engine_pv_count" title="">811</div>
                    </td>
                    <td class="number visitor_count"   colspan="">
                        <div class="td-content" id="engine_visitor_count" title="">607</div>
                    </td>
                    <td class="number ip_count"   colspan="">
                        <div class="td-content" id="engine_ip_count" title="">577</div>
                    </td>
                    <td class="ratio group bounce_ratio"   colspan="">
                        <div class="td-content" id="engine_bounce_ratio" title="">90.65%</div>
                    </td>
                    <td class="time avg_visit_time"   colspan="">
                        <div class="td-content" id="engine_avg_visit_time" title="">00:03:09</div>
                    </td>
        ...
        <div class="table_btm">
            ...
            <button type="button" class="btn btn-default vs_btn1 btn_gao">20</button>
            <button type="button" class="btn btn-default dropdown-toggle btn_gao1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="caret"></span>
                <span class="sr-only">Toggle Dropdown</span>
            </button>
            <ul class="dropdown-menu">
                <li class=""><a class="size" href="#">20</a></li>
                <li ><a class="size" href="#">50</a></li>
                <li><a class="size" href="#">100</a></li>
            </ul>
        </div>
