...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/remind/remind/"><spring:message
					code="admin.remind" /> <spring:message code="admin.common.list" /></a></li>
		<shiro:hasPermission name="remind:remind:edit">
			<li><a href="${ctx}/remind/remind/form"> <spring:message
						code="admin.remind" /> <spring:message code="admin.common.add" /></a></li>
		</shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="remind"
		action="${ctx}/remind/remind/" method="post"
		...
		<tbody>
			<c:forEach items="${page.list}" var="remind">
				<tr>
					...
					<td><fmt:formatDate value="${remind.updateDate}"
							pattern="yyyy-MM-dd HH:mm:ss" /></td>
					<shiro:hasPermission name="remind:remind:edit">
						<td><a href="${ctx}/remind/remind/form?id=${remind.id}"><spring:message
									code="admin.common.modify" /></a> <a
							href="${ctx}/remind/remind/delete?id=${remind.id}"
