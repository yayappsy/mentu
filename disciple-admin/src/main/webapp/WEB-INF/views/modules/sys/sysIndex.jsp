...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			// 绑定菜单单击事件
			$("#menu").find("a.menu").click(function(){
				// 一级菜单焦点
			...
			// 初始化点击第一个一级菜单
			$("#menu").find("a.menu:first span").click();
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span id="systemName">${fns:getConfig('system.name')}</span></div>
				<ul id="userControl" class="nav pull-right">
					<li><a href="${fns:getSettingValue('siteUrl', 'site')}" target="_blank" title="访问网站主页"><i class="icon-home"></i></a></li>
				...
				<%-- <c:if test="${cookie.theme.value eq 'cerulean'}">
					...
					<script type="text/javascript">
						$("#systemName").hide();$("#user").html($("#userControl"));$("#header").prepend($("#user, #logo"));
					</script>
				</c:if> --%>
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
							<c:if test="${menu.parent.id eq '1' and menu.isShow}">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; ${fns:getSettingValue('copyright', 'site')} ${fns:getSettingValue('siteName', 'site')} 
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
