...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="permission" htmlEscape="false" rows="3"
					maxlength="500" class="input-xxlarge" />
				<span class="help-inline">控制器中定义的权限标识，如：@RequiresPermissions("权限标识"),以英文逗号为分割</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">权限分割:</label>
			<div class="controls">
				<form:checkbox path="ifSeparate"
						...
						class="trueFalse" />
				<span class="help-inline">是否进行权限分割，如果是，则会创建子菜单，子菜单权限是权限标识的子集，父菜单的权限标识则为空</span>
			</div>
		</div>
		<div class="control-group">
