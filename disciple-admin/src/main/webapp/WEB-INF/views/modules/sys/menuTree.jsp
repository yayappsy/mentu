...
<div class="accordion" id="menu-${param.parentId}">
	...
	<c:forEach items="${menuList}" var="menu" varStatus="idxStatus">
		<c:if
			test="${menu.parent.id eq (not empty param.parentId ? param.parentId:1)&&menu.isShow}">
					...
					<div class="accordion-inner">
						<ul class="nav nav-list">
							<c:forEach items="${menuList}" var="menu2">
								<c:if test="${menu2.parent.id eq menu.id && menu2.isShow}">
									<li><a data-href=".menu3-${menu2.id}"
										...
										<ul class="nav nav-list hide"
											...
											<c:forEach items="${menuList}" var="menu3">
												<c:if
													test="${menu3.parent.id eq menu2.id&&menu3.isShow}">
