...
<%@ attribute name="resultMessage" type="com.weimhc.framework.web.ResultMessage"
...
<c:if test="${not empty resultMessage}">
	<c:set var="code" value="${resultMessage.code }" />
	<c:set var="type" value="${resultMessage.type }" />
</c:if>
