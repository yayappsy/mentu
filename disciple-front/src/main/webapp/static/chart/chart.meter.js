...
var Meter = (function () {
    ...
    var element, 
        ...
        labelStyle,
        innerStyle,
        backgroundStyle;//added by zsm 2016-08-23 为了显示背景为透明
    ...
    var drawing = function(w, h) {
        ...
        var timer = setInterval(function(){
            ...
            if(backgroundStyle.isRgba){
            	 context.fillStyle = backgroundStyle.rgba;
            }else{
    ...
    exports.setOptions = function(opts){
        ...
        backgroundStyle = styles.background;//added by zsm 2016-08-23 为了显示背景为透明
