...
<html>
<head>
<title><spring:message code="客服服务" /></title>
<meta name="decorator" content="front_home" />
<link href="${ctxStatic }/modules/rysh/front/css/singlepage.css" rel="stylesheet" type="text/css" />
...
<div class="m-position">
	<ul class="clearfix">
    	<li>当前位置</li><li>&gt;</li><li>首页</li><li>&gt;</li><li>${article.category.name}</li>
    </ul>
</div>
<!--当前位置 end-->
<!--main-->
