...
<title><spring:message code="shop.resourceNotFound.title" /></title>
...
<body>
	...
	<div class="m-main clearfix yahei"
		...
		<div style="width: 535px; padding: 40px 20% 0px; height: 245px;">
			<c:choose>
				<c:when test="${type ne null and type eq 'product'}">
					<p style="font-size: 20px;">
						<span
							style="font-size: 25px; color: #1752A5; padding-right: 10px;"></span>
					    <spring:message code="shop.product.error.noResut" />
					</p>
				</c:when>
				<c:when test="${type ne null and type eq 'store'}">
					<p style="font-size: 20px;">
						<span
							style="font-size: 25px; color: #1752A5; padding-right: 10px;"></span>
					    <spring:message code="shop.store.error.noResut" />
					</p>
				</c:when>
				<c:otherwise>
					<p
						...
						<spring:message code="shop.resourceNotFound.message" />
					</p>
				</c:otherwise>
			</c:choose>
			<p style="margin-top: 20px;">
				您可以：<a href="${ctx }"
					...
					<spring:message code="shop.resourceNotFound.home" />
