...
import com.weimhc.modules.gen.dao.GenSchemeDao;
import com.weimhc.modules.gen.dao.GenTableColumnDao;
import com.weimhc.modules.gen.dao.GenTableDao;
...
public class GenSchemeService extends BaseServiceImpl {
	...
	private String generateCode(GenScheme genScheme) {
		...
		genTable.setColumnList(genTableColumnDao
				.findList(new GenTableColumn(new GenTable(genTable.getId()))));
		...
		for (GenTable childTable : genTable.getChildList()) {
			...
			childTable.setColumnList(genTableColumnDao.findList(
					new GenTableColumn(new GenTable(childTable.getId()))));
