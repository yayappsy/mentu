...
public class LnkParser {
	...
	private static Logger logger = LoggerFactory.getLogger(LnkParser.class);
	...
	public void parse(File f) throws Exception {
		...
		realFile = getNullDelimitedString(link, local_sys_off);
		p("real filename = " + realFile);
	}
	...
	public static void main(String[] args) {
		String path = "D:\\develop-soft\\web_server\\tomcat\\apache-tomcat-8.0.24-eclipse-shop\\webapps\\shops-front\\static\\ueupload.lnk";
		try {
			new LnkParser(new File(path));
		} catch (Exception e) {
