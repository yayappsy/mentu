...
public class ImageHunter {
	...
	public ImageHunter(Map<String, Object> conf) {
		...
		this.uploadFolder = (String) conf.get("uploadFolder");
	}
	...
	public State captureRemoteData(String urlStr) {
		...
		try {
			...
			String savePath = this.getPath(this.savePath, this.filename,
					suffix);
			...
			String filePath = UploadUtils
					.getPath(PathFormat.format(physicalPath));

			if (state.isSuccess()) {
				state.putInfo("url", UploadUtils.BASE_URL + filePath);
