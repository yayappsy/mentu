 ...
 * 
 */
package com.thinkgem.javamg.common.supcan.common;

import java.util.List;

import com.google.common.collect.Lists;
import com.thinkgem.javamg.common.supcan.common.fonts.Font;
...
public class Common {
	...
	public Common() {
		properties = new Properties(IdGen.uuidByIdWorker());
