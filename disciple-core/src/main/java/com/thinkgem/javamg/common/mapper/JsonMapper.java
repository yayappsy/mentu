...
public class JsonMapper extends ObjectMapper {
	 ...
	 * 反序列化复杂Bean
	 * 
	 * @see com.fasterxml.jackson.core.type.TypeReference.TypeReference()
	 */
	public <T> T fromJson(String jsonString, TypeReference<T> typeRef) {
		if (StringUtils.isEmpty(jsonString)) {
			return null;
		}
		try {
			return this.readValue(jsonString, typeRef);
		} catch (IOException e) {
			logger.warn("parse json string error:" + jsonString, e);
			return null;
		}
	...
	public static <T> T fromJsonString(String jsonString,
		...
		return JsonMapper.getInstance().fromJson(jsonString, typeRef);
	}
